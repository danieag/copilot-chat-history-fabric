...
## Overview
For many Copilot Studio makers and administrators it can be challenging to pull the conversation transcript data from Dataverse and understanding Application Inishgts and Log Analytics in Azure may be "a bridge too far".  
...
5. Setup the Dataverse Link to Microsoft Fabric to synchronize the following tables: **ConversationTranscript** (conversationtranscript) and **User** (systemsuer).  For more on this topic check out the following article [Link to Microsoft Fabric](https://learn.microsoft.com/en-us/power-apps/maker/data-platform/fabric-link-to-data-platform).  
